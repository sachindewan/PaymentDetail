    ...
    public partial class PaymentDetailsAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PayentDetailsId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CardOwnerName = table.Column<string>(type: "varchar(300)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_payentDetails", x => x.PayentDetailsId);
                });
        }
